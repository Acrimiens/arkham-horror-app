class Auth:
    ...
    _mesa_access_codes = {
        ...
        "mesa04": {"group": 2, "era": "pasado"},   # Mesa 01 accede al Grupo 1, era Pasado
        "mesa05": {"group": 2, "era": "presente"}, # Mesa 02 accede al Grupo 1, era Presente
        "mesa06": {"group": 2, "era": "futuro"},   # Mesa 03 accede al Grupo 1, era Futuro
        "mesa07": {"group": 3, "era": "pasado"},   # Mesa 01 accede al Grupo 1, era Pasado
        "mesa08": {"group": 3, "era": "presente"}, # Mesa 02 accede al Grupo 1, era Presente
        "mesa09": {"group": 3, "era": "futuro"},   # Mesa 03 accede al Grupo 1, era Futuro
        "mesa10": {"group": 4, "era": "pasado"},   # Mesa 01 accede al Grupo 1, era Pasado
        "mesa11": {"group": 4, "era": "presente"}, # Mesa 02 accede al Grupo 1, era Presente
        "mesa12": {"group": 4, "era": "futuro"},   # Mesa 03 accede al Grupo 1, era Futuro
    ...
    _rooms = [{"name": f"Grupo {i+1}", "id": i+1} for i in range(4)]
